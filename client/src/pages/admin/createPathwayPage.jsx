...
function CreatePathwayPage() {
    ...
    const { createPathway } = usePathwayStore((state) => state);
    ...
    const createPathwayHandler = async () => {
        const createdPathway = {
            title: title,
            description: description,
            enrolledUsers: enrolledUsers,
            materials: materials,
        };
        console.log(createdPathway);
        await createPathway(createdPathway);
    };
        ...
        <div className=" h-full flex flex-col ">
            <div className="">
                <div className="flex items-center justify-between px-4 py-2">
                    <h2 className="text-lg font-medium">Create Pathway</h2>
                    <div className="flex items-center gap-2">
                        {/* Base */}

                        <button
                            onClick={createPathwayHandler}
